...
public class PercolationQF {
    ...
    private final QuickFindUF uf;  // uf for checking percolation, which has virtual sites for both top and bottom
    private final QuickFindUF ufBackwash;  //uf for preventing backwash in isFull(), which has only virtual top site
    ...
    public PercolationQF(int N) {
        ...
        ufBackwash = new QuickFindUF(N * N + 1);
        numOfOpen = 0;
        virtualBottom = N * N + 1;
    }
